...
1. 先看 `sdio_driver` 怎么注册
2. 再看 `sdio bus` 是什么
3. 然后看 match 怎样命中 `id_table`
4. 最后看 `sdio_bus_probe()` 做完公共准备后，如何进入真正的 function driver `probe()`
